...
static void GMT130_V1_TFT_InitController(void)
{
	/* Reset the display controller */
	    ...
	    SPI_st7789v_write_data(0x00);    /* MADCTL: memory data access control */

	    SPI_st7789v_write_command(ST7789V_CMD_VSCRDEF);
	    SPI_st7789v_write_data(0x00);
	    SPI_st7789v_write_data(0x00);
	    SPI_st7789v_write_data(0x14);
	    SPI_st7789v_write_data(0x00);
	    SPI_st7789v_write_data(0x00);
	    SPI_st7789v_write_data(0x00);

	    SPI_st7789v_write_command(ST7789V_CMD_NORON);

	    SPI_st7789v_write_command(ST7789V_CMD_INVON);

	    SPI_st7789v_write_command(ST7789V_CMD_COLMOD);
	    SPI_st7789v_write_data(0x55);    /* COLMOD: Interface Pixel format */
	    ...
	    SPI_st7789v_write_data(0x00);
	    SPI_st7789v_write_data(0x00);
	    SPI_st7789v_write_data(0xEF);    /* X address set */
